...
# CONNECTING TO PORTS
arrow_left = pygame.image.load("img/arrowleft.png")
arrow_right = pygame.image.load("img/arrowright.png")
arrow_down = pygame.image.load("img/arrowdown.png")
logobig = pygame.image.load("img/linesbig.png")
logobig_rect = logobig.get_rect()
font = pygame.font.Font("fonts/edosz.ttf", 30)
medfont = pygame.font.Font("fonts/edosz.ttf", 32)
bigfont = pygame.font.Font("fonts/edosz.ttf", 60)
C = Colors()
screen.fill(C.black)
...
logo = pygame.image.load("img/lines.png")
